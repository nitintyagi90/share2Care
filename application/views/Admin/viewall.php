                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title clr">Total Enquiry</h4>
                            ...
                            <div class="col-sm-12">
                                    ...
                                    <div class="row pd-bt">
                                       ...
                                       <select class="form-control"   id="Interest">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <button class="btn btn-danger" onclick="myfunction4();"> Search</button>
                                        </div>
                                        </div>
                                       <!--  <div class="col-md-6">
                              ...
                              <!--               <td><?php echo $value['email']; ?></td> -->
                                          ...
                                          <td> <span id="citys"><select class="form-control" id="city_<?php echo $value['id']; ?>" onchange="updatealot('<?php echo $value['id']; ?>');">
                                            ...
                                            <td class="text-center">
                                               <a href="<?php echo base_url('Admin/view/'.$value['user_id'].'/'.$value['id']); ?>"><i class="fa fa-eye"></i></a>&nbsp;&nbsp;</a>
