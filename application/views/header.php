...
<link rel="stylesheet" href="<?php echo base_url();?>new/bootstrap/css/circle.css" />
<!-- google font -->
...
var marqueebgcolor=""
var pauseit=1
var marqueecontent='<nobr><font face="Arial">Thank you for visiting Share2care.</a></font></nobr>'
...
<?php } ?>
<?php if($page == 'event'){ ?>
<li><a href="https://share2care-foundation.blogspot.com/" class="colr grow curren">Events</a></li>
...
<ul class="dropdown-menu drp drp-weight">
<li><a href="<?php echo base_url('Admin');?>" class="bckclr1">Admin</a></li>
<li><a href="<?php echo base_url('login');?>" class="bckclr1">User</a></li>
<li><a href="<?php echo base_url('Vendor');?>" class="bckclr1">Expert</a></li>
</ul>
</li>
<?php }else{ ?>
<li class="dropdown bckclr">
